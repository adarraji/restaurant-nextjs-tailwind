...
const LoginPage = () => {
    ...
    return (
        <div className="p-4 h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex items-center justify-center">
            {/* BOX */}
            <div className="h-full shadow-2xl rounded-md flex flex-col md:flex-row md:h-[70%] w-full lg:h-[60%] 2xl:w-1/2">
                {/* IMAGE CONTAINER */}
                ...
                <div className="p-10 flex flex-col gap-8 md:w-1/2">
                    ...
                    <button onClick={() => signIn("google")} className="flex gap-4 p-4 ring-1 ring-orange-100 rounded">
