...
const getData = async () => {
    const res = await fetch(`${process.env.SERVER_URL}/api/categories`, { cache: "no-store" })
    if (!res.ok) {
...
const MenuPage = async () => {
    ...
    return (
        <div className="p-4 lg:px-20 xl:px40 h-[calc(100vh-6rem)]  md:h-[calc(100vh-9rem)] flex flex-col md:flex-row items-center">
